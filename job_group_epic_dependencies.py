...
def process(job: Dict[str, Any]) -> Tuple[bool, str]:
    """Process Group Epic Dependencies job type.
    ...
    job_type = job.get("job_type", "Group Epic Dependencies")
    ...
    parts = ["=== GROUP EPIC DEPENDENCIES DATA ==="]
    ...
    print(f"📤 Calling LLM for Group Epic Dependencies (input: {len(formatted)} chars)")
    ...
    result_text = f"""Group Epic Dependencies Analysis Completed
